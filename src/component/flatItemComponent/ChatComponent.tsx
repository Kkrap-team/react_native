...
const ChatComponent: React.FC = ({ }) => {
    ...
    return (
        <View style={styles.container}>
            <Text style={textTheme.noto28_000000_Bold}>친구와 폴더를</Text>
            <View style={styles.container_text} >
                <Text style={textTheme.noto28_5AB7FC_Bold}>공유</Text>
                <Text style={textTheme.noto28_000000_Bold}>하며</Text>
            </View>
            <View style={styles.container_text} >
                <Text style={textTheme.noto28_5AB7FC_Bold}>채팅</Text>
